...
pub type DemoWeave = DependentWeave<u64, TextContent, String, DefaultHashBuilder>;
pub type DemoNode = DependentNode<u64, TextContent, DefaultHashBuilder>;
pub type IndependentDemoWeave = IndependentWeave<u64, TextContent, String, DefaultHashBuilder>;
pub type IndependentDemoNode = IndependentNode<u64, TextContent, DefaultHashBuilder>;
